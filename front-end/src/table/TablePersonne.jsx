import { Table, Space, Avatar, Input, Button, Modal, message } from 'antd';
...
function TablePersonne() {
  ...
  const handleDeleteSelected = () => {
    confirm({
      title: 'Êtes-vous sûr de vouloir supprimer les personnes sélectionnées ?',
      content: 'Cette action est irréversible.',
      okText: 'Oui',
      okType: 'danger',
      cancelText: 'Non',
      onOk: async () => {
        try {
          await axios.post('/api/crud/personnes/bulk-delete', { ids: selectedRowKeys });
          ...
          message.error('Erreur lors de la suppression des personnes sélectionnées.');
